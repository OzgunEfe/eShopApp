...
//  eShopApp
//
//  Created by Ozgun Efe on 04/08/2024.
//
...
class PaymentHandler: NSObject {
    ...
    // This applePayStatus function is not used in this app. Use it to check for the ability to make payments using canMakePayments(), and check for available payment cards using canMakePayments(usingNetworks:).
